...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.objects = [this.plane, this.pyramid, this.cone, this.tangram, this.cube, this.parallelogram];

        // Labels and ID's for object selection on MyInterface
        this.objectIDs = { 'Plane': 0 , 'Pyramid': 1, 'Cone': 2, 'Tangram': 3, 'Cube': 4, 'Parallelogram': 5};
        ...
        this.ambientLights = 5  ;

    }
    initLights() {
        this.setGlobalAmbientLight(0.3*this.ambientLights, 0.1*this.ambientLights, 0.1*this.ambientLights, 1.0);
    ...
    initMaterials() {
        ...
        this.material4.setAmbient(0.2, 0.2, 0.2, 1.0);
    ...
    display() {
        ...
        this.setGlobalAmbientLight(0.1*this.ambientLights, 0.1*this.ambientLights, 0.1*this.ambientLights, 1.0);
